...
import com.hazelcast.demo.trademonitor.trade.TradeJsonDeserializer;
...
public class AggregateQuery {
    ...
    private static final long FIVE_SECONDS_IN_MS = 5 * 1_000L;
    ...
    private static void addMaxVolumeAlert(
        ...
        .window(WindowDefinition.tumbling(FIVE_SECONDS_IN_MS))
